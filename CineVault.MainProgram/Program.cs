    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            // Mock data for Actor
            Actor actor1 = new Actor { Id = IdGenerator.GenerateId(), Name = "Leonardo DiCaprio", IMDBEntry = new IMDBEntry { Name = "Leonardo DiCaprio", Url = "https://www.imdb.com/name/nm0000138/", Type = IMDBType.Actor } };
            Actor actor2 = new Actor { Id = IdGenerator.GenerateId(), Name = "Morgan Freeman", IMDBEntry = new IMDBEntry { Name = "Morgan Freeman", Url = "https://www.imdb.com/name/nm0000151/", Type = IMDBType.Actor } };
            Actor actor3 = new Actor { Id = IdGenerator.GenerateId(), Name = "Tom Hanks", IMDBEntry = new IMDBEntry { Name = "Tom Hanks", Url = "https://www.imdb.com/name/nm0000158/", Type = IMDBType.Actor } };
            Actor actor4 = new Actor { Id = IdGenerator.GenerateId(), Name = "Meryl Streep", IMDBEntry = new IMDBEntry { Name = "Meryl Streep", Url = "https://www.imdb.com/name/nm0000658/", Type = IMDBType.Actor } };
            Actor actor5 = new Actor { Id = IdGenerator.GenerateId(), Name = "Brad Pitt", IMDBEntry = new IMDBEntry { Name = "Brad Pitt", Url = "https://www.imdb.com/name/nm0000093/", Type = IMDBType.Actor } };
            Actor actor6 = new Actor { Id = IdGenerator.GenerateId(), Name = "Scarlett Johansson", IMDBEntry = new IMDBEntry { Name = "Scarlett Johansson", Url = "https://www.imdb.com/name/nm0424060/", Type = IMDBType.Actor } };
            Actor actor7 = new Actor { Id = IdGenerator.GenerateId(), Name = "Robert De Niro", IMDBEntry = new IMDBEntry { Name = "Robert De Niro", Url = "https://www.imdb.com/name/nm0000134/", Type = IMDBType.Actor } };
            Actor actor8 = new Actor { Id = IdGenerator.GenerateId(), Name = "Jennifer Lawrence", IMDBEntry = new IMDBEntry { Name = "Jennifer Lawrence", Url = "https://www.imdb.com/name/nm2225369/", Type = IMDBType.Actor } };
            Actor actor9 = new Actor { Id = IdGenerator.GenerateId(), Name = "Will Smith", IMDBEntry = new IMDBEntry { Name = "Will Smith", Url = "https://www.imdb.com/name/nm0000226/", Type = IMDBType.Actor } };
            Actor actor10 = new Actor { Id = IdGenerator.GenerateId(),Name = "Angelina Jolie", IMDBEntry = new IMDBEntry { Name = "Angelina Jolie", Url = "https://www.imdb.com/name/nm0001401/", Type = IMDBType.Actor } };
            Actor actor11 = new Actor { Id = IdGenerator.GenerateId(),Name = "Johnny Depp", IMDBEntry = new IMDBEntry { Name = "Johnny Depp", Url = "https://www.imdb.com/name/nm0000136/", Type = IMDBType.Actor } };
            Actor actor12 = new Actor { Id = IdGenerator.GenerateId(), Name = "Emma Watson", IMDBEntry = new IMDBEntry { Name = "Emma Watson", Url = "https://www.imdb.com/name/nm0914612/", Type = IMDBType.Actor } };

            // Mock data for Director
            Director director1 = new Director { Id = IdGenerator.GenerateId(),Name = "Christopher Nolan", IMDBEntry = new IMDBEntry { Name = "Christopher Nolan", Url = "https://www.imdb.com/name/nm0634240/", Type = IMDBType.Director } };
            Director director2 = new Director { Id = IdGenerator.GenerateId(),Name = "Steven Spielberg", IMDBEntry = new IMDBEntry { Name = "Steven Spielberg", Url = "https://www.imdb.com/name/nm0000229/", Type = IMDBType.Director } };
            Director director3 = new Director { Id = IdGenerator.GenerateId(),Name = "Quentin Tarantino", IMDBEntry = new IMDBEntry { Name = "Quentin Tarantino", Url = "https://www.imdb.com/name/nm0000233/", Type = IMDBType.Director } };
            Director director4 = new Director { Id = IdGenerator.GenerateId(),Name = "Martin Scorsese", IMDBEntry = new IMDBEntry { Name = "Martin Scorsese", Url = "https://www.imdb.com/name/nm0000217/", Type = IMDBType.Director } };
            Director director5 = new Director { Id = IdGenerator.GenerateId(),Name = "Ridley Scott", IMDBEntry = new IMDBEntry { Name = "Ridley Scott", Url = "https://www.imdb.com/name/nm0000631/", Type = IMDBType.Director } };

            // Mock data for Movie
            Movie movie1 = new Movie { Id = IdGenerator.GenerateId(), Title = "Inception", Barcode = "1234567890123", Director = director1, Actors = new List<Actor> { actor1 }, IMDBEntry = new IMDBEntry { Name = "Inception", Url = "https://www.imdb.com/title/tt1375666/", Type = IMDBType.Movie }, Seen = true, Score = 9, Year = "2010", CoverUrl = "https://m.media-amazon.com/images/M/MV5BMmFjNTM0YjktYzYwZC00ZDE1LWI5YzMtYzY0YjY3YjYzYzYzXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg" };
            Movie movie2 = new Movie { Id = IdGenerator.GenerateId(), Title = "The Shawshank Redemption", Barcode = "9876543210987", Director = director2, Actors = new List<Actor> { actor2 }, IMDBEntry = new IMDBEntry { Name = "The Shawshank Redemption", Url = "https://www.imdb.com/title/tt0111161/", Type = IMDBType.Movie }, Seen = false, Score = 10, Year = "1994", CoverUrl = "https://m.media-amazon.com/images/M/MV5BMDFkYTc0MGEtZmNhMC00ZDI3LWFmNTEtODM1ZmRlZjE2N2YxXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_.jpg" };
            Movie movie3 = new Movie { Id = IdGenerator.GenerateId(), Title = "Pulp Fiction", Barcode = "1234567890456", Director = director3, Actors = new List<Actor> { actor3, actor11 }, IMDBEntry = new IMDBEntry { Name = "Pulp Fiction", Url = "https://www.imdb.com/title/tt0110912/", Type = IMDBType.Movie }, Seen = true, Score = 8, Year = "1994", CoverUrl = "https://m.media-amazon.com/images/M/MV5BZjhkOTdjNzAtM2YwZC00ZDE1LWI5YzMtYzY0YjY3YjYzYzYzXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg" };
            Movie movie4 = new Movie { Id = IdGenerator.GenerateId(), Title = "The Godfather", Barcode = "9876543210678", Director = director4, Actors = new List<Actor> { actor7 }, IMDBEntry = new IMDBEntry { Name = "The Godfather", Url = "https://www.imdb.com/title/tt0068646/", Type = IMDBType.Movie }, Seen = true, Score = 10, Year = "1972", CoverUrl = "https://m.media-amazon.com/images/M/MV5BM2MyNjYxNmYtYzYwZC00ZDE1LWI5YzMtYzY0YjY3YjYzYzYzXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg" };
            Movie movie5 = new Movie { Id = IdGenerator.GenerateId(), Title = "Gladiator", Barcode = "1234509876123", Director = director5, Actors = new List<Actor> { actor5 }, IMDBEntry = new IMDBEntry { Name = "Gladiator", Url = "https://www.imdb.com/title/tt0172495/", Type = IMDBType.Movie }, Seen = true, Score = 9, Year = "2000", CoverUrl = "https://m.media-amazon.com/images/M/MV5BMTg2NjY2NjY2Nl5BMl5BanBnXkFtZTcwODg2NjY2Mw@@._V1_.jpg" };
            Movie movie6 = new Movie { Id = IdGenerator.GenerateId(), Title = "Titanic", Barcode = "3210987654321", Director = director2, Actors = new List<Actor> { actor1, actor10 }, IMDBEntry = new IMDBEntry { Name = "Titanic", Url = "https://www.imdb.com/title/tt0120338/", Type = IMDBType.Movie }, Seen = true, Score = 10, Year = "1997", CoverUrl = "https://m.media-amazon.com/images/M/MV5BMDdmZGU2YjktYzYwZC00ZDE1LWI5YzMtYzY0YjY3YjYzYzYzXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg" };
